...
==================
  ...
  * columwith now is 100 and for the gvim
  * Loading the _auth.vim file also little changes into the README.md file.
  * Authentication for some of the VIM Plugins now will be into _auth.vim file
  * Merge branch 'master' of github.com:bdryanovski/vimrc
  * Cleanup all unused files that I found today.
  * Updating the README.md
  * Updating the README.md
  * column width 100
  * Adding new theme Hemisu
  * Cleanup and mapinig the home key
  * Remove stylus vim plugin
  * git submodule update
  * Removing showmarks pluging - I really did not use it all and don't find a reason to use it...
  * git submodule update
  * Adding submodule showmarks - to help me start using markes in Vim
  *  Updating my notes
  * Using VIM Strict Mapping http://learnvimscriptthehardway.stevelosh.com/chapters/05.html
  * PHPUnit shortcut for running test
  * Making auto change working dir when opening file - very nice
  * New short-keys for editing and some settings noting big ...
  * Adding new color scheme http://blog.toddwerth.com/entries/8 ir_black
  * Updating the F-Keys and VIM custom documentation.
  * Merge branch 'master' of github.com:bdryanovski/vimrc
  * Trying to find the best settings for neocomplecache, for now there is a little hope
  * Syncing with *nix push
  * Found a little bug with loading RailsEnvy for now it will use the old one solarized
  * Foreach submodule update
  * Using RailsEnvy for colorscheme
  * Start tracking vim colorschemes and selecting new one
  * Fix bug with syntastic file check - when checking less files
  * Fixing GUI flash/beep bug under Windows
